module github.com/jiangguilong2000/go-spring/examples/spring-web-gin
...
require (
	...
	github.com/jiangguilong2000/go-spring/spring-gin v1.0.1
)
...
//	github.com/jiangguilong2000/go-spring/spring-gin => ../../spring/spring-gin
//)
